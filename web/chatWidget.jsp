...
<div id="ai-chat-container">
    ...
    <div id="ai-chat-window" class="card border-0 shadow-lg d-none fade-in-up" style="background: #1e293b; color: #f8fafc; border-radius: 1rem;">
        ...
        <div class="card-body p-3" id="ai-chat-messages" style="height: 350px; overflow-y: auto; background: #0f172a; font-size: 0.9rem;">
            <!-- Welcome message -->
            <div class="d-flex mb-3">
                <div class="bot-msg shadow-sm" style="max-width: 85%;">
                    Hello! I'm your LifeFlow AI Assistant. 🩺<br>I'm currently in high-security dark mode. How can I assist you?
                </div>
            </div>
        </div>
        <div class="card-footer border-0" style="background: #1e293b; border-radius: 0 0 1rem 1rem;">
            <div class="input-group">
                <input type="text" id="ai-chat-input" class="form-control form-control-sm rounded-pill px-3 text-light" style="background-color: #334155; border: 1px solid #475569;" placeholder="Ask me anything..." onkeypress="handleKey(event)">
...
<script>
    (function() {
        // Scoped functions to avoid conflicts
        ...
        function appendMessage(text, isUser) {
            ...
            var contentClass = isUser ? 'user-msg' : 'bot-msg';
            div.innerHTML = '<div class="' + contentClass + ' shadow-sm" style="min-width: 30px;">' + text + '</div>';
        ...
        window.showTyping = function() {
            var div = document.createElement('div');
            div.className = "ai-typing-indicator d-flex mb-3";
        ...
        function removeTyping() {
            var indicators = document.querySelectorAll(".ai-typing-indicator");
